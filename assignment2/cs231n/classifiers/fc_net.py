...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    #backprop
    dh1, dW2, db2 = affine_backward(dscores, cache_h2)
...
class FullyConnectedNet(object):
  ...
  def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
    ...
    ############################################################################
    size_layer = [input_dim] + hidden_dims + [num_classes]
    for i in range(self.num_layers):
        #self.params['W'+str(i+1)] = np.sqrt(2.0/size_layer[i+1]) * np.random.randn(size_layer[i], size_layer[i+1])
        self.params['W'+str(i+1)] = weight_scale * np.random.randn(size_layer[i], size_layer[i+1])
  ...
  def loss(self, X, y=None):
    ...
    for i in range(self.num_layers):
        ...
        if self.use_dropout:
            out_dropout, cache_dropout = dropout_forward(out_relu, self.dropout_param)
            layer_cache['dropout'+str(i+1)] = cache_dropout
        else:
